    ...
    return (
      <form onSubmit={this.submitForm}>
        <fieldset>
          ...
          <fieldset className="form-group">
            <textarea className="form-control form-control-lg" rows="8" placeholder="Share some info about you..." value={this.state.bio} onChange={this.updateState('bio')}></textarea>
          </fieldset>
          ...
          <button className="btn btn-lg publishBtn pull-xs-right" type="submit" disabled={this.state.inProgress}>Update Settings</button>
        ...
        <div className="container page">
          <div className="row">
            <div className="col-md-6 offset-md-3 col-xs-12">
              ...
              <button className="btn btn-outline-danger logout" onClick={this.props.onClickLogout}>Logout</button>
